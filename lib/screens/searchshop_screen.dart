...
class SearchShopScreen extends StatefulWidget {
  ...
  @override
  SearchShopScreenState createState() => SearchShopScreenState();
}

class SearchShopScreenState extends State<SearchShopScreen> {
  ...
  Future<void> _fetchProducts() async {
    _productsFuture = ProductService().getFilteredProducts(count: 70);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar1(title: "What are you looking?"),
      body: SafeArea(
